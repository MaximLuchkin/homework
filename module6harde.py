...
class Circle(Figure):
    ...
    def __init__(self, color=(0, 0, 0), *sides):
        ...
        self.__radius = self.get_sides()[0] / (2 * pi) if self.get_sides() else 0.0
    ...
    def set_sides(self, length):
        ...
        self.__radius = length / (2 * pi) if length else 0.0
...
class Triangle(Figure):
    ...
    def get_square(self):
        if len(self.__sides) == 3:
            ...
            area = (p * (p - self.__sides[0]) * (p - self.__sides[1]) * (p - self.__sides[2])) ** 0.5
            return area
        return 0

    def set_sides(self, a, b, c):
        super().set_sides(a, b, c)
        self.__height = (2 * self.get_square()) / a if a != 0 else 0
